 ...
 * as follows:
 * - PGRES_FATAL_ERROR: Indicates a serious error in the query. Clear the PGresult and return NULL.
 ...
 * as follows:
 * - PGRES_FATAL_ERROR: Indicates a serious error in the query. Clear the PGresult and return -1.
