...
{
    Table* r = Database::new_table("r", ColumnNames{"b1", "a", "b2"});
    add(r, {"1", "10", "111"});
    add(r, {"1", "11", "111"});
    add(r, {"2", "0", "222"});
    add(r, {"3", "10", "333"});
    add(r, {"3", "11", "333"});
    Table* s = Database::new_table("s", ColumnNames{"b1", "b2", "c"});
    add(s, {"1", "111", "100"});
    add(s, {"1", "111", "101"});
    add(s, {"3", "333", "200"});
    add(s, {"3", "333", "201"});
    add(s, {"3", "333", "202"});
    add(s, {"4", "444", "0"});
    Table* control = Database::new_table("control", ColumnNames{"b1", "a", "b2", "c"});
    add(control, {"1", "10", "111", "100"});
    add(control, {"1", "10", "111", "101"});
    add(control, {"1", "11", "111", "100"});
    add(control, {"1", "11", "111", "101"});
    add(control, {"3", "10", "333", "200"});
    add(control, {"3", "10", "333", "201"});
    add(control, {"3", "10", "333", "202"});
    add(control, {"3", "11", "333", "200"});
    add(control, {"3", "11", "333", "201"});
    add(control, {"3", "11", "333", "202"});
    assert(table_eq(control, join(r, s)));
}

static void join_both_non_empty_2()
{
    Table* r = Database::new_table("r", ColumnNames{"a1", "a2", "b"});
    add(r, {"10", "1000", "1"});
    add(r, {"10", "1000", "3"});
    add(r, {"11", "1100", "1"});
    add(r, {"11", "1100", "3"});
    add(r, {"0", "0", "2"});
    Table* s = Database::new_table("s", ColumnNames{"c", "a2", "a1"});
    add(s, {"100", "1000", "10"});
    add(s, {"101", "1000", "10"});
    add(s, {"200", "1000", "10"});
    add(s, {"201", "1100", "11"});
    Table* control = Database::new_table("control", ColumnNames{"a1", "a2", "b", "c"});
    add(control, {"10", "1000", "1", "100"});
    add(control, {"10", "1000", "1", "101"});
    add(control, {"10", "1000", "1", "200"});
    add(control, {"10", "1000", "3", "100"});
    add(control, {"10", "1000", "3", "101"});
    add(control, {"10", "1000", "3", "200"});
    add(control, {"11", "1100", "1", "201"});
    add(control, {"11", "1100", "3", "201"});
    assert(table_eq(control, join(r, s)));
}
